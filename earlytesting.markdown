...
Known Issues
 ...
 - I believe the pilgrim shrines may not currently properly ignore the faithless trait. I will address this
...
## Changes (from previous 3.0.0 RC)
 ...
 - The "Expanded" profile is now the default profile, and what was the default profile is now called "Slim"
...
### Removed
 ...
 - DynDOLOD DLL SE
 - Additional Music (Rest in pepperonis)
