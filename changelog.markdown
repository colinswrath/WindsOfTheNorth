...
### Bug Fixes
 ...
 - The "Warmth" and "Hearthfire" spell tombs now use the correct alteration inventory icon
...
### Added
 ...
 - Skylighting
 - SSGI (Disabled by default, but you can enable if you would like. AO only is enabled the default config)
 ...
 - Tundra Homestead - Tweaks and Enhancements
 - The New Normal
 ...
 - Sound Fix for Large Sector Drives (optional)
 ...
 - Enhanced Worldspace Maps - Sovengarde
 - Relighting Skyrim
 - Civil War Healers
 - Civil War Healers Tweaks
...
### Removed
 ...
 - Elven Supremecy
 - Skyrim Silver
 - Gibberish - Currency Swapper for Skyrim Extended Cut
 - Alduin's Wall - Descriptions
 - City Bag Checks
 - Bow of Shadows - Reduced Cut
 - CC Dawnfang and Duskfang - No Forced Quest
 - C.O.I.N.
 - COIN - Treasury Exchange
 - COIN Exclusions
 ...
 - Old Orc Follower - Default Face NPCs Fixed Patch (no longer needed)
 - Fancy Fishing
 ...
 - Precision Creatures
 - Horse Stamina HUD - Script-Free (not needed with TrueHUD)
 - WotN - Heightmaps (No longer needed)
 ...
 - Morthal Wheres Wares (somewhat redundant with Environs)
 - Custom Window (does not work on w11)
 - Face Discoloration Fix
 - Staff Enchanting Plus
 - Simonrim - Staff Enchanting Plus patch
